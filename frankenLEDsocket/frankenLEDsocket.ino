...
SimplePatternList gPatterns = { Frainbow, rainbowWithGlitter, confetti, sinelon, juggle, bpm };
...
void startWiFi() { // Start a Wi-Fi access point, and try to connect to some given access points. Then wait for either an AP or STA connection
  ...
  wifiMulti.addAP("LivehauSF", "hotdrop321");   // add Wi-Fi networks you want to connect to
  wifiMulti.addAP("homegirls", "claradebcarrie!");
